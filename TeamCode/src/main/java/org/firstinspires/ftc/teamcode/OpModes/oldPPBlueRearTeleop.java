...
@Disabled
@TeleOp(group = "TEST",name="Test: Blue Rear TeleOp PedroPath")
public class oldPPBlueRearTeleop extends OpMode {
...
//    private int StartPosition = 1; // Front is 1
    ...
    public void init() {
        ...
        if(PoseStorage.currentPose==null) {
            ...
            if (AllianceColor == 1) {
                if (StartPosition==1) {
                    startingPose = new Pose(57.5, 9, Math.toRadians(90));
                } else if (StartPosition==2) {
                    startingPose = new Pose(29.5, 134, Math.toRadians(270));
                }
            } else if (AllianceColor == 2) {
                if (StartPosition==1) {
                    startingPose = new Pose(144-57.5, 9, Math.toRadians(90));
                } else if (StartPosition==2) {
                    startingPose = new Pose(144-29.5, 134, Math.toRadians(270));
                }
            }
