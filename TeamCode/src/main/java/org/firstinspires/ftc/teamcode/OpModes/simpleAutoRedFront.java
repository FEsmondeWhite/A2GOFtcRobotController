...
@Configurable
@Autonomous(group = "Auto",name="Simple Auto Red front", preselectTeleOp="TeleOp Red front")
public class simpleAutoRedFront extends ppSimpleAutoBase {
    public simpleAutoRedFront() {
