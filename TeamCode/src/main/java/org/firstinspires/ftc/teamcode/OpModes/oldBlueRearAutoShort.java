...
@Disabled
@Autonomous(group = "TEST",name="Test: Blue rear auto short PedroPath")
public class oldBlueRearAutoShort extends OpMode {
    ...
    private final Pose startPose = new Pose(33.9, 134.2, Math.toRadians(90));
