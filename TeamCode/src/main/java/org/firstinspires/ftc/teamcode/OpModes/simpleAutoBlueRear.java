...
@Configurable
@Autonomous(group = "Auto",name="Simple Auto Blue rear", preselectTeleOp="TeleOp Blue rear")
public class simpleAutoBlueRear extends ppSimpleAutoBase {
    public simpleAutoBlueRear() {
