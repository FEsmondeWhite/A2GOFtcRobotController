...
@Configurable
@Autonomous(group = "Auto",name="Simple Auto Red rear", preselectTeleOp="TeleOp Red rear")
public class simpleAutoRedRear extends ppSimpleAutoBase {
    public simpleAutoRedRear() {
