...
@Disabled
@Autonomous(name = "Blue Auto Rear - PP", group = "Opmode")
@Configurable // Panels
@SuppressWarnings("FieldCanBeLocal") // Stop Android Studio from bugging about variables being predefined
public class oldApriltagBlueAutoRear extends LinearOpMode {
    ...
    // Built using https://visualizer.pedropathing.com/
    public static class Paths {

        public PathChain StartPoint;
        public PathChain ShootfromBack;
        public PathChain StartFrontStackPickup;
        public PathChain PickupBall1;
        public PathChain PickupBall2;
        public PathChain PickupBall3;

        public Paths(Follower follower) {
            StartPoint = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(55.500, 12.500), new Pose(55.500, 15.000))
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(83))
                    .build();

            ShootfromBack = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(55.500, 15.000), new Pose(57.000, 17.000))
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(83), Math.toRadians(113))
                    .build();

            StartFrontStackPickup = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(57.000, 17.000), new Pose(40.000, 38.000))
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(113), Math.toRadians(180))
                    .build();

            PickupBall1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(40.000, 38.000), new Pose(36.000, 38.000))
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();

            PickupBall2 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(36.000, 38.000), new Pose(31.000, 38.000))
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();

            PickupBall3 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(31.000, 38.000), new Pose(26.000, 38.000))
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();
        }
